...
// TODO: Rename FeedActivity to be more generic because now it has rotating fragments
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.action_home:
                        // TODO: Update fragment to go to feed
                        Toast.makeText(FeedActivity.this, "Navigating Home", Toast.LENGTH_SHORT).show();
                        fragment = new FeedFragment();
                        break;
                    case R.id.action_compose:
                        Toast.makeText(FeedActivity.this, "Navigating Create", Toast.LENGTH_SHORT).show();
                        fragment = new ComposeFragment();
                        break;
                    case R.id.action_profile:
                        // TODO: Update fragment to go to profile
                        Toast.makeText(FeedActivity.this, "Navigating Profile", Toast.LENGTH_SHORT).show();
                        fragment = new ComposeFragment();
                        break;
                    default:
